...
| ------- | ---------------------- | ------------------------- | ------------------------------------- |
| Rater   | [`rater.md`](rater.md) | [`src/core`](../src/core) | [`tests/src/core`](../tests/src/core) |

## By directory

| Directory  | Guide                  |
| ---------- | ---------------------- |
| `src/core` | [`rater.md`](rater.md) |
...
- [`AGENTS.md`](../AGENTS.md) — the coding contract, whose Documentation contract section governs this index.
